...
func (PluginCapability_AlphaFeature_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{4, 2, 0}
}
...
const (
	...
	ControllerServiceCapability_AlphaFeature_LIST_VOLUMES_VOLUME_HEALTH ControllerServiceCapability_AlphaFeature_Type = 1
	// Indicates the SP supports the GetVolume RPC
	ControllerServiceCapability_AlphaFeature_GET_VOLUME ControllerServiceCapability_AlphaFeature_Type = 2
	// Indicates the SP supports the
	// GetVolumeResponse.volume_health field
	ControllerServiceCapability_AlphaFeature_VOLUME_HEALTH ControllerServiceCapability_AlphaFeature_Type = 3
)

var ControllerServiceCapability_AlphaFeature_Type_name = map[int32]string{
	0: "UNKNOWN",
	1: "LIST_VOLUMES_VOLUME_HEALTH",
	2: "GET_VOLUME",
	3: "VOLUME_HEALTH",
}
...
func (ControllerServiceCapability_AlphaFeature_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{31, 1, 0}
}
...
const (
	...
	VolumeHealth_TEMPORARY_DEGRADED VolumeHealth_Condition = 20
	...
	VolumeHealth_FAILURE_LIKELY VolumeHealth_Condition = 30
	...
	VolumeHealth_FATAL VolumeHealth_Condition = 40
)

var VolumeHealth_Condition_name = map[int32]string{
	0:  "UNKNOWN",
	1:  "HEALTHY",
	10: "TEMPORARY_INACCESSIBLE",
	20: "TEMPORARY_DEGRADED",
	30: "FAILURE_LIKELY",
	40: "FATAL",
}

var VolumeHealth_Condition_value = map[string]int32{
	"UNKNOWN":                0,
	"HEALTHY":                1,
...
func (x VolumeHealth_Condition) String() string {
	return proto.EnumName(VolumeHealth_Condition_name, int32(x))
}

func (VolumeHealth_Condition) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	NodeServiceCapability_AlphaFeature_VOLUME_HEALTH NodeServiceCapability_AlphaFeature_Type = 1
)
...
func (NodeServiceCapability_AlphaFeature_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{55, 1, 0}
}
...
func (*PluginCapability_AlphaFeature) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{4, 2}
}
...
func (m *PluginCapability_AlphaFeature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PluginCapability_AlphaFeature.Merge(m, src)
}
...
type ListVolumesResponse_VolumeStatus struct {
	...
	// This field is OPTIONAL.
	VolumeHealth         *VolumeHealth `protobuf:"bytes,2,opt,name=volume_health,json=volumeHealth,proto3" json:"volume_health,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *ListVolumesResponse_VolumeStatus) GetVolumeHealth() *VolumeHealth {
	if m != nil {
		return m.VolumeHealth
	}
	return nil
}
...
type GetVolumeResponse struct {
	...
	Status               *GetVolumeResponse_VolumeStatus `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                        `json:"-"`
	XXX_unrecognized     []byte                          `json:"-"`
	XXX_sizecache        int32                           `json:"-"`
}
...
func (m *GetVolumeResponse) GetStatus() *GetVolumeResponse_VolumeStatus {
	if m != nil {
		return m.Status
	}
	return nil
...
type GetVolumeResponse_VolumeStatus struct {
	// volume_health shows error conditions reported by the SP.
	// This field MUST be specified if the
	// VOLUME_HEALTH controller capability is supported.
...
func (m *GetVolumeResponse_VolumeStatus) Reset()         { *m = GetVolumeResponse_VolumeStatus{} }
func (m *GetVolumeResponse_VolumeStatus) String() string { return proto.CompactTextString(m) }
func (*GetVolumeResponse_VolumeStatus) ProtoMessage()    {}
func (*GetVolumeResponse_VolumeStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{26, 0}
}

func (m *GetVolumeResponse_VolumeStatus) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetVolumeResponse_VolumeStatus.Unmarshal(m, b)
}
func (m *GetVolumeResponse_VolumeStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetVolumeResponse_VolumeStatus.Marshal(b, m, deterministic)
}
func (m *GetVolumeResponse_VolumeStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetVolumeResponse_VolumeStatus.Merge(m, src)
}
func (m *GetVolumeResponse_VolumeStatus) XXX_Size() int {
	return xxx_messageInfo_GetVolumeResponse_VolumeStatus.Size(m)
}
func (m *GetVolumeResponse_VolumeStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_GetVolumeResponse_VolumeStatus.DiscardUnknown(m)
}

var xxx_messageInfo_GetVolumeResponse_VolumeStatus proto.InternalMessageInfo

func (m *GetVolumeResponse_VolumeStatus) GetVolumeHealth() *VolumeHealth {
	if m != nil {
		return m.VolumeHealth
	}
	return nil
...
func (*ControllerServiceCapability_AlphaFeature) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{31, 1}
}
...
func (m *ControllerServiceCapability_AlphaFeature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ControllerServiceCapability_AlphaFeature.Merge(m, src)
}
...
func (m *NodeGetVolumeStatsResponse) GetVolumeHealth() *VolumeHealth {
	if m != nil {
		return m.VolumeHealth
	}
	return nil
...
type VolumeHealth struct {
	...
	// This field is REQUIRED.
	Condition VolumeHealth_Condition `protobuf:"varint,1,opt,name=condition,proto3,enum=csi.v1.VolumeHealth_Condition" json:"condition,omitempty"`
	// The error code and message describing the health condition of
	// the volume. This field is REQUIRED.
	Error                []*VolumeHealth_VolumeHealthError `protobuf:"bytes,2,rep,name=error,proto3" json:"error,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}

func (m *VolumeHealth) Reset()         { *m = VolumeHealth{} }
func (m *VolumeHealth) String() string { return proto.CompactTextString(m) }
func (*VolumeHealth) ProtoMessage()    {}
func (*VolumeHealth) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{52}
}

func (m *VolumeHealth) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_VolumeHealth.Unmarshal(m, b)
}
func (m *VolumeHealth) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_VolumeHealth.Marshal(b, m, deterministic)
}
func (m *VolumeHealth) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VolumeHealth.Merge(m, src)
}
func (m *VolumeHealth) XXX_Size() int {
	return xxx_messageInfo_VolumeHealth.Size(m)
}
func (m *VolumeHealth) XXX_DiscardUnknown() {
	xxx_messageInfo_VolumeHealth.DiscardUnknown(m)
}

var xxx_messageInfo_VolumeHealth proto.InternalMessageInfo

func (m *VolumeHealth) GetCondition() VolumeHealth_Condition {
	if m != nil {
		return m.Condition
	}
	return VolumeHealth_UNKNOWN
}

func (m *VolumeHealth) GetError() []*VolumeHealth_VolumeHealthError {
	if m != nil {
		return m.Error
	}
	return nil
...
type VolumeHealth_VolumeHealthError struct {
...
func (m *VolumeHealth_VolumeHealthError) Reset()         { *m = VolumeHealth_VolumeHealthError{} }
func (m *VolumeHealth_VolumeHealthError) String() string { return proto.CompactTextString(m) }
func (*VolumeHealth_VolumeHealthError) ProtoMessage()    {}
func (*VolumeHealth_VolumeHealthError) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{52, 0}
}

func (m *VolumeHealth_VolumeHealthError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_VolumeHealth_VolumeHealthError.Unmarshal(m, b)
}
func (m *VolumeHealth_VolumeHealthError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_VolumeHealth_VolumeHealthError.Marshal(b, m, deterministic)
}
func (m *VolumeHealth_VolumeHealthError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VolumeHealth_VolumeHealthError.Merge(m, src)
}
func (m *VolumeHealth_VolumeHealthError) XXX_Size() int {
	return xxx_messageInfo_VolumeHealth_VolumeHealthError.Size(m)
}
func (m *VolumeHealth_VolumeHealthError) XXX_DiscardUnknown() {
	xxx_messageInfo_VolumeHealth_VolumeHealthError.DiscardUnknown(m)
}

var xxx_messageInfo_VolumeHealth_VolumeHealthError proto.InternalMessageInfo

func (m *VolumeHealth_VolumeHealthError) GetCode() string {
	if m != nil {
		return m.Code
	}
	return ""
...
func (m *VolumeHealth_VolumeHealthError) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func (*NodeServiceCapability_AlphaFeature) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{55, 1}
}
...
func (m *NodeServiceCapability_AlphaFeature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NodeServiceCapability_AlphaFeature.Merge(m, src)
}
...
func init() {
	...
	proto.RegisterEnum("csi.v1.VolumeHealth_Condition", VolumeHealth_Condition_name, VolumeHealth_Condition_value)
	...
	proto.RegisterType((*GetVolumeRequest)(nil), "csi.v1.GetVolumeRequest")
	proto.RegisterType((*GetVolumeResponse)(nil), "csi.v1.GetVolumeResponse")
	proto.RegisterType((*GetVolumeResponse_VolumeStatus)(nil), "csi.v1.GetVolumeResponse.VolumeStatus")
	...
	proto.RegisterType((*VolumeHealth)(nil), "csi.v1.VolumeHealth")
	proto.RegisterType((*VolumeHealth_VolumeHealthError)(nil), "csi.v1.VolumeHealth.VolumeHealthError")
...
var fileDescriptor_9cdb00adce470e01 = []byte{
	...
	,
}
...
func (c *controllerClient) GetVolume(ctx context.Context, in *GetVolumeRequest, opts ...grpc.CallOption) (*GetVolumeResponse, error) {
	out := new(GetVolumeResponse)
	err := c.cc.Invoke(ctx, "/csi.v1.Controller/GetVolume", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedControllerServer) GetVolume(ctx context.Context, req *GetVolumeRequest) (*GetVolumeResponse, error) {
...
func _Controller_GetVolume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVolumeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControllerServer).GetVolume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/csi.v1.Controller/GetVolume",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerServer).GetVolume(ctx, req.(*GetVolumeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Controller_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Controller_GetVolume_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "github.com/container-storage-interface/spec/csi.proto",
